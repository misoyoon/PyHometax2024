...
def file_download(ht_info, v_file_type):
    ...
    # [인쇄] 버튼 클릭
    logt("GUI Click: [인쇄]", 5.0)   #  2023년 상당히 느리게 동작하고 있음
    ...
    logt(f"다운로드 팝업창 뜨기 = {v_file_type}")
    time.sleep(3)
    ...
    try:
        ...
        pyautogui.typewrite(fullpath)  # 한글경로 오류니 조심하기(영문 패스만 사용할 것)
        time.sleep(0.2)
