...
'''
위택스 지방소득세 신고를 위한 전자파일 생성
행정안전부 2023.07일 VER 1.2.3 기준으로 작성됨
  ...
  def __init__(self, conn=None, ht_series_yyyymm='', group_id='', ht_tt_seq='') -> None:
    ...
    self.layout_data = {
      '01C116300': {
          ...
          , '세목구분코드':               {'num':3,  'val':None,   'len':6,   'type':'CHAR',   'null':False, 'class':'FIX',   'fixval':'140002'}
          , '신고서식코드':               {'num':4,  'val':None,   'len':5,   'type':'CHAR',   'null':False, 'class':'FIX',   'fixval':'B4011'}
          , '세무프로그램코드':           {'num':5,  'val':None,   'len':4,   'type':'CHAR',   'null':False, 'class':'VAR',   'fixval':'__세무프로그램코드__'} # 기타 9000번 사용
          , '세무대리법입코드':           {'num':6,  'val':None,   'len':13,  'type':'CHAR',   'null':True,  'class':'VAR',   'fixval':'__the1_법인번호__'}
          , '세무대리법인명':             {'num':7,  'val':None,   'len':80,  'type':'CHAR',   'null':True,  'class':'VAR',   'fixval':'__the1_법인명__'}
          , '세무대리사업자번호':         {'num':8,  'val':None,   'len':10,  'type':'CHAR',   'null':True,  'class':'VAR',   'fixval':'__the1_사업자번호__'}
          , '세무대리연락처':             {'num':9,  'val':None,   'len':16,  'type':'CHAR',   'null':True,  'class':'VAR',   'fixval':'__the1_대표전화번호__'}
          , '납부기한':                   {'num':10, 'val':None,   'len':8,   'type':'CHAR',   'null':True,  'class':'VAR',   'fixval':'__납부기한__'}
          , '적용서식':                   {'num':11, 'val':None,   'len':10,  'type':'CHAR',   'null':False, 'class':'FIX',   'fixval':'V2020.1.01'}
      }
      ,'02C116300' : {
